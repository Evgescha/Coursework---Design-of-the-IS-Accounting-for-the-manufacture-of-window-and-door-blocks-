...
namespace _2009_1956_DoorAndWindow
{
    public partial class StoreDoor : Form
    {
        ...
        private void StoreDoor_Load(object sender, EventArgs e)
        {
            ...
            // TODO: данная строка кода позволяет загрузить данные в таблицу "movedbDataSet.изготовление_дверных_блоков". При необходимости она может быть перемещена или удалена.
            this.изготовление_дверных_блоковTableAdapter.Fill(this.movedbDataSet.изготовление_дверных_блоков);
        ...
        private void add()
        {
            ...
            try
            {
                DataRowView row = (DataRowView)изготовлениеДверныхБлоковBindingSource.AddNew();
                ...
                изготовлениеДверныхБлоковBindingSource.EndEdit();
                this.изготовление_дверных_блоковTableAdapter.Update(movedbDataSet);
                this.изготовление_дверных_блоковTableAdapter.Fill(this.movedbDataSet.изготовление_дверных_блоков);
                clearFields();
                fixDataGridColumnsText();
            }
        ...
        private void edit()
        {
            ...
            try
            {
                ...
                изготовлениеДверныхБлоковBindingSource.EndEdit();
                this.изготовление_дверных_блоковTableAdapter.Update(((DataRowView)dataGridView1.CurrentRow.DataBoundItem).Row);
                this.изготовление_дверных_блоковTableAdapter.Fill(this.movedbDataSet.изготовление_дверных_блоков);
        ...
        private void delete()
        {
            if (dataGridView1.Rows.Count > 0 && dataGridView1.CurrentRow != null)
            {
                try
                {
                    изготовлениеДверныхБлоковBindingSource.RemoveAt(dataGridView1.CurrentRow.Index);
                    изготовление_дверных_блоковTableAdapter.Update(movedbDataSet.изготовление_дверных_блоков);
                    this.изготовление_дверных_блоковTableAdapter.Fill(this.movedbDataSet.изготовление_дверных_блоков);
                    fixDataGridColumnsText();
                }
                catch (Exception e)
